                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="men">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="img/{{$menn->path}}" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                              <figcaption>
                              <h4 class="aa-product-title"><a href="#"> {{$menn['name']}} </a></h4>
                              <span class="aa-product-price">$ {{$menn['Cost']}} </span>
                            </figcaption>
                          </figure>                        
                      ...
                      <a class="aa-browse-btn" href="/allproduct">Browse all Product <span class="fa fa-long-arrow-right"></span></a>
                    </div>
                      ...
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            ...
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">{{$womenn['name']}} </a></h4>
                              <span class="aa-product-price">${{$womenn['Cost']}} </span>
                            </figcaption>
                          </figure>                         
                          <div class="aa-product-hvr-content">
                            <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist"><span class="fa fa-heart-o"></span></a>
                    ...
                    @foreach ($sport as $sportt)  
                        ...
                        <li>
                          <figure>
                            ...
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">{{$sportt['name']}}</a></h4>
                              <span class="aa-product-price">${{$sportt['Cost']}}</span>
                            </figcaption>
                          </figure>                         
                          <div class="aa-product-hvr-content">
                            <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist"><span class="fa fa-heart-o"></span></a>
                    ...
                    <div class="tab-pane fade" id="electronics">
                       <ul class="aa-product-catg">
                        ...
                        @foreach ($electronic as $electronicc)  

                        <!-- start single product item -->
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="img/{{$electronicc->path}}" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">{{$electronicc['name']}}</a></h4>
                              <span class="aa-product-price">${{$electronicc['Cost']}}</span>
                            </figcaption>
                          </figure>                         
                          <div class="aa-product-hvr-content">
                            <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist"><span class="fa fa-heart-o"></span></a>
